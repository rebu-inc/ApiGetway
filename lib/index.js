...
const resolvers$1 = {
	...
	Mutation: {
		...
		loginUser:(_,{user} )=>{
			console.log(generalRequest(`${URL$1}/${auth}/${Login}`, 'POST', user, true) );//endpoint para editar usuario
			console.log(getRequest(`${URL$1}/${auth}/${Login}`));
		}
	}
};
...
const url$5 = 'http://34.123.130.41:8080';
